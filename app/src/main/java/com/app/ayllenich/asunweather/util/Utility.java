...
public class Utility {
    ...
    /**
     *  将服务器返回到所有天气信息存储到SharedPreferences文件中。
     */
    public static void saveWeatherInfo(Context context, String cityName, String weatherCode, String temp1, String temp2, String weatherDesp, String publisTeme) {
        ...
        editor.putString("publish_time", publisTeme);

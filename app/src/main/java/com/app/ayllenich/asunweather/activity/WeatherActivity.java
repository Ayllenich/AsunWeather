    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.switch_city:
                ...
                intent.putExtra("from_weather_activity", true);//加入标志位防止跳转回ChooseAreaActivity,会立刻又跳转回来。
            ...
            case R.id.refresh_weather:
                ...
                String weatherCode = prefs.getString("weather_code", ""); //Utility.saveWeatherInfo()中保存的天气代号
